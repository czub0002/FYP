...
class DataScraper:
    ...
    def get_journal(self):
        ...
        """
        title_element = self.html_content.select_one('.journal-heading')
        if title_element:
            journal_title = self.string_cleaner(title_element.get_text())
        else:
    ...
    def get_url(self):
        ...
        """
        if self.doi:
            url = "https://www.tandfonline.com/doi/full/" + self.doi
        else:
