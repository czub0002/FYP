...
for i in range(0, 64):
    if i < 10:
        excel_files.append('wiley_data/Copy of Wiley_Data_000' + str(i) + '.xlsx')
    else:
        excel_files.append('wiley_data/Copy of Wiley_Data_00' + str(i) + '.xlsx')

# Specify the path to your JSON file
json_file_path = 'Results/wiley_data_obj.json'
...
for file_path in excel_files:
    ...
    with open('wiley_data_obj.json', 'w') as file:
...
def print_results(self):
    ...
    with pd.ExcelWriter('wiley_results.xlsx') as writer:
    ...
    sys.stdout = open('wiley_results_file.txt', 'w')
    rt.print_results()
